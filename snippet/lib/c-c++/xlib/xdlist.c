...
//******************************************************************************
//******************************************************************************
//*    The implemention file of the duplex List                               **
 ...
 * Return: If success, return the pointer; or, return NULL.
 *         If "List" is NULL, return NULL.
 * Others: None.
 */
XSList * x_slist_create(XSList *List)
{
  if (List == NULL){
    return NULL;
  }

  List = (XSList *)malloc(sizeof(XSList));
  if (List == NULL){
    return NULL;
  }else{
    List->head = NULL;
